...
/*BS参数说明-详情可以看图片 说明.png
 ...
 验证udid还是idfv:YES  设置YES获取描述文件获取UDID ，NO 获取IDFV无需描述文件,IDFV弊端同设备不同app获取机器码码不同，刷机 升级 还原 会变,想同设备多个app通用卡密的建议UDID
 ...
 试用模式:YES  添加了试用功能 如开启  试用模式:YES 并且shiyong.php上传至服务器站点目录下 可以是二级目录 具体打开shiyong.php看注释说明,
